...
@OnlyIn(Dist.CLIENT)
public class EndermanLeaderRenderer extends MobRenderer<EndermanEntity, EndermanModel<EndermanEntity>> {
    ...
    public EndermanLeaderRenderer(EntityRendererManager renderManagerIn) {
